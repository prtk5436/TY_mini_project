...
import com.example.tyminiproject.BuildConfig;
...
public class ChatMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loginButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    final ProgressDialog progressDialog = new ProgressDialog(ChatMainActivity.this);
        ...
        visitorButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                progressDialog.setCancelable(false);
                progressDialog.show();
                Kommunicate.init(ChatMainActivity.this, APP_ID);
                Kommunicate.loginAsVisitor(ChatMainActivity.this, new KMLoginHandler() {
                    @Override
    ...
    public void initLoginData(String userId, String password, final ProgressDialog progressDialog) {
        ...
        Kommunicate.login(ChatMainActivity.this, user, new KMLoginHandler() {
            @Override
            public void onSuccess(RegistrationResponse registrationResponse, Context context) {
